...
public class LogAspectOfPointCut {
     ...
     *                                  对应下面的basic.example.spring._ioc.day3.test1.*, 表示basic.example.spring._ioc.day3.test1这个包下所有的类
     *                                  也支持basic.example.spring._ioc.day3.test1..*,(-> *前面可是.. <-) 表示basic.example.spring._ioc.day3.test1这个包及其子包中所有的类
    ...
    // 要求被代理的目标类上面拥有basic.example.spring._ioc.day3.test1.pointcut.Test1 这个注解
    ...
    // 要求被代理的方法上拥有basic.example.spring._ioc.day3.test1.pointcut.Test1 这个注解
    @Pointcut("@annotation(basic.example.spring._ioc.day3.test1.pointcut.Test1)")
